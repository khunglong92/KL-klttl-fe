  ...
  if (variant === "outline-primary")
    return (
      <Button
        ...
        variant="outline"
        disabled={disabled}
        className={`group relative overflow-hidden rounded-lg bg-white/10 backdrop-blur-md border-black/30 text-white hover:bg-white/20 hover:text-white transition-all duration-300 ${className}`}
      >
        {/* Glow for outline button - contained */}
        <motion.span
          aria-hidden
