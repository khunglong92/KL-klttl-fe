      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="relative flex-1">
          ...
          <input
            type="text"
            placeholder={t(
              "services.filter.searchPlaceholder",
              "Tìm kiếm dịch vụ..."
            )}
            value={searchQuery}
        ...
        >
          <button
            ...
            title={t("services.filter.grid", "Lưới")}
          >
          ...
          <button
            ...
            title={t("services.filter.compact", "Gọn")}
          >
