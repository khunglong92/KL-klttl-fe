  ...
  return (
    ...
    >
      ...
      <div className="relative flex-1 max-w-md">
        ...
        <input
          ...
          className={cn(
            ...
            theme === "dark"
              ? "bg-[#1a1c20] border-[#2d3f5e] text-white placeholder:text-gray-500 focus:border-cyan-500"
      ...
      <div className="flex items-center gap-4">
        ...
        >
          {t("categories.listTitle", "Hiển thị")} {totalShowing}/
          {totalRecruitment}
        </span>
