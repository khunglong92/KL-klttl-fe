...
export default function ProductsListComponent() {
  ...
  const features = [
    {
      icon: Award,
      title: t("products.features.iso.title"),
      description: t("products.features.iso.description"),
      gradient: "from-amber-500 to-orange-600",
    },
    {
      icon: Clock,
      title: t("products.features.delivery.title"),
      description: t("products.features.delivery.description"),
      gradient: "from-blue-500 to-cyan-600",
    },
    {
      icon: Shield,
      title: t("products.features.warranty.title"),
      description: t("products.features.warranty.description"),
    ...
    () => [
      {
        value: companyInfo?.yearsOfExperience
          ...
          : "15+",
        label: t("products.achievements.experience"),
        icon: Sparkles,
      },
      {
        value: companyInfo?.projectsCompleted
          ...
          : "5000+",
        label: t("products.achievements.projects"),
        icon: CheckCircle2,
      },
      {
        value: companyInfo?.satisfactionRate
          ...
          : "98%",
        label: t("products.achievements.satisfaction"),
        icon: Award,
      },
      { value: "24/7", label: t("products.achievements.support"), icon: Clock },
    ],
    [companyInfo, t]
  );
          ...
          <div className="max-w-5xl">
            ...
            >
              ...
              <p className="text-lg md:text-xl leading-relaxed max-w-3xl font-light text-white/90">
                ...
                <span className="font-bold text-amber-400">±0.01mm</span>,{" "}
                {t(
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {contactCards.map((item, index) => (
              ...
              >
                ...
                <div className="text-sm font-medium text-center uppercase tracking-wider mb-3 relative z-10 text-muted-foreground">
                  {item.label}
                </div>
