...
export function ProductCard({
  ...
  const isAvailable = true; // Default to true since stock is removed from schema
  const statusLabel = t(
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute left-4 right-4 top-4 flex items-start justify-end sm:left-5 sm:right-5">
          <span
            className={cn(
