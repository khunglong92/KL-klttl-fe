...
// import "quill/dist/quill.core.css"; // Optional, usually snow includes core
// @ts-ignore
    ...
    <Stack gap="md">
      <Box>
        <Text size="md" fw={600} mb={4} c={textColor}>
          {t(
            "productsPage.admin.form.labels.detailedDescription",
            "Nội dung chi tiết sản phẩm"
          )}
        </Text>
        <Text size="sm" c="dimmed" mb="md">
          {t(
            "productsPage.admin.form.labels.detailedHint",
      ...
      <Paper withBorder p={0} radius="md" style={{ overflow: "hidden" }}>
        <ReactQuill
          ...
          placeholder={t(
            "productsPage.admin.placeholders.detailedContent",
